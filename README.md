...
Contains the prevalence of encoding for each behavioral variable that were derived from Fig. 2a of Engelhard et al., 2019.  
* **observed_counts.csv**:\
Contains the observed numbers of encoding 0-5 variables for the all neurons population and for the reward responsive neurons subset that were derived from Fig. 3b of Engelhard et al., 2019.
